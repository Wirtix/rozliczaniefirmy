              ...
              {signature ? (
                <>
                  ...
                  <p className="text-[10px] leading-tight text-slate-700">
                    <span className="block font-semibold text-slate-800 mb-1">ID podpisu</span>
                    <span className="block w-full whitespace-pre-wrap break-words rounded-md bg-slate-900 px-2 py-1 font-mono text-[10px] leading-[1.4] tracking-tight text-slate-50 shadow-inner ring-1 ring-slate-800/50">
                      {signatureIdWrapped}
                    </span>
                  </p>
                  <p>Data: {signedAt}</p>
